...
const MQTTPanel = ({ topics = ['weather/temp','weather/humidity','weather/wind'], lastUpdate = '3 sec ago', status = true }) => {
  return (
    <div className="neumorph p-6 flex flex-col items-center justify-center w-full h-full text-center">
      <h3 className="font-bold text-sm uppercase text-white/90 mb-2">MQTT Panel</h3>
      ...
      <div className="font-bold text-sm text-white/70">Topics</div>
